	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/MZ_DSG_PLANNER/home.php"><span>MZ_DSG_PLANNER </span> ADMIN PAGE</a>
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="/MZ_DSG_PLANNER/"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Logout</a></li>
						</ul>
					</li>
				</ul>
